 ...
 */
const AvatarCard: React.FC<AvatarCardProps> = ({ profile, loading, avatarRing, resumeFileUrl }): JSX.Element => {
  return (
    <div className="card shadow-lg compact bg-base-100">
      <div className="grid place-items-center py-8">
        ...
        {resumeFileUrl &&
          (loading ? (
            <div className="mt-6">{skeleton({ widthCls: "w-40", heightCls: "h-8" })}</div>
          ) : (
            <a
              href={resumeFileUrl}
              target="_blank"
